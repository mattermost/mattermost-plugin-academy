...
const playbooks: Guide = {
    ...
    title: 'Workflow Automation with Playbooks',
    heroTitle: 'Workflow Automation with Playbooks',
    subtitle: 'Checklists, status updates, playbook setup, automatic triggers, and retrospectives for repeatable processes.',
    description: 'Checklists, status updates, playbook setup, automatic triggers, and retrospectives for repeatable processes.',
