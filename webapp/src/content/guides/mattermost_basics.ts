...
const mattermostBasics: Guide = {
    ...
    subtitle: 'Channels, threads, notifications, composing, formatting, slash commands, and the shortcuts you use every day.',
    description: 'Channels, threads, notifications, composing, formatting, slash commands, and the shortcuts you use every day.',
