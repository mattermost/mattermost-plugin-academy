...
const updateGuide: Guide = {
    ...
    subtitle: 'Release tracks, upgrade paths, preflight checks, the procedure for your deployment type, verification, and rollback.',
    description: 'Release tracks, upgrade paths, preflight checks, the procedure for your deployment type, verification, and rollback.',
    icon: 'update',
    audiences: ['admin'],
        ...
        },
        {
            ...
            steps: [
                ...
                },
                {
                    ...
                    description: 'Announce the upgrade in a channel with links people can act on. Send them to <a href="/academy/guides/ai-quick-start">AI Acceleration with Agents</a> for agents, summaries, and rewrites, <a href="/academy/guides/mattermost-basics">Collaboration Basics</a> for anyone still finding their way around, <a href="/academy/guides/productivity-tips">Productivity Tips</a> for shortcuts, scheduled messages, and notifications, and <a href="/academy/guides/advanced-search">Advanced Search Techniques</a> for people who lose time hunting for old messages.',
                },
                {
