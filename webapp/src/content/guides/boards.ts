...
const boards: Guide = {
    ...
    title: 'Project Tracking with Boards',
    heroTitle: 'Project Tracking with Boards',
    subtitle: 'Navigation, templates, cards, properties, views, and sharing so you can organize tasks next to the conversation.',
    description: 'Navigation, templates, cards, properties, views, and sharing so you can organize tasks next to the conversation.',
    icon: 'product-boards',
    audiences: ['end-user'],
